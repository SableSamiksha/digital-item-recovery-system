...
/**
 * LostItem entity representing items reported as lost by users.
...
public class LostItem {
    ...
    public LostItem(String name, String description, LocalDate date, String location, String contact) {
        this.name = name;
